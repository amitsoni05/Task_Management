...
$.fn.AdminSettings = function (settings) {
    ...
    var defaults = {
        ...
        Layout: 'vertical', // 
        LogoBg: 'skin3', // You can change the Value to be skin3/skin2/skin3/skin4/skin5/skin6 
        NavbarBg: 'skin6', // You can change the Value to be skin3/skin2/skin3/skin4/skin5/skin6 
        SidebarType: 'full', // You can change it full / mini-sidebar
        SidebarColor: 'skin3', // You can change the Value to be skin3/skin2/skin3/skin4/skin5/skin6
        ...
        ManageThemeBackground: function () {
            ...
            function setlogobg() {
                ...
                if (lbg != undefined && lbg != "") {
                    ...
                    $('#' + myid + ' .topbar .top-navbar .navbar-header').attr("data-logobg", "skin3");
                }
            };
            setlogobg();
            // Navbar bg attribute
            function setnavbarbg() {
                ...
                if (nbg != undefined && nbg != "") {
                    ...
                    $('#' + myid + ' .topbar .navbar-collapse').attr("data-navbarbg", "skin3");
                     $('#' + myid + ' .topbar').attr("data-navbarbg", "skin3");
                    $('#' + myid).attr("data-navbarbg", "skin3");
                }
            };
            setnavbarbg();
        }
        ...
        ManageSidebarColor: function () {
            ...
            function setsidebarbg() {
                ...
                if (sbg != undefined && sbg != "") {
                    ...
                    $('#' + myid + ' .left-sidebar').attr("data-sidebarbg", "skin3");
                }
            };
            setsidebarbg();
        }
